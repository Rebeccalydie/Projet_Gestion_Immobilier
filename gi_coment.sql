...
COMMENT ON TABLE historiques_locations
IS 'Cette table contient la liste de la date de tous les logements qui ont été louer.'

COMMENT ON TABLE historiques_vente
IS 'Cette table contient la liste de la date de tous les logements qui ont été vendus par les proprietaires.'

COMMENT ON TABLE maisons_location
IS 'Cette table contient la liste de tous les logements qui sont ont été affiché par les proprietaires pour etre loué.'

COMMENT ON TABLE maisons_vente
